#############################################################################
# Makefile for building: fin_track
# Generated by qmake (3.1) (Qt 5.15.15)
# Project:  fin.pro
# Template: app
# Command: /usr/bin/qmake -o Makefile fin.pro
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = fin_track1.0.0
DISTDIR = /home/Cynide/Projects/fin_tracker/.tmp/fin_track1.0.0
LINK          = g++
...
Makefile: fin.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/sanitize.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
...
distdir: FORCE
	...
	$(COPY_FILE) --parents fin_gui.cpp $(DISTDIR)/
...
fin_gui.o: fin_gui.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o fin_gui.o fin_gui.cpp
